...
cv2.imwrite('TC918_1_BGR_dE.bmp', BGR_IMAGE[0:28*bs, 0:20*bs])
cv2.imwrite('TC918_2_BGR_dE.bmp', BGR_IMAGE[28*bs:55*bs, 0:20*bs])
cv2.imwrite('TC918_1_BGR1_dE.bmp', BGR1_IMAGE[0:28*bs, 0:20*bs])
cv2.imwrite('TC918_2_BGR1_dE.bmp', BGR1_IMAGE[28*bs:55*bs, 0:20*bs])
cv2.imwrite('dE_IMAGE.bmp', dE_IMAGE)
...
cv2.imshow('dE_IMAGE.bmp', dE_IMAGE)
cv2.waitKey(0)